...
//##### INTERNAL BEGIN #####
#if 0
extern uint32_t EthClientGWAddrGet(void);
extern uint32_t EthClientSubNetGet(void);
extern uint32_t EthClientDNSAddrGet(void);
extern uint32_t EthClientProxyAddrGet(void);
#endif
//##### INTERNAL END #####
