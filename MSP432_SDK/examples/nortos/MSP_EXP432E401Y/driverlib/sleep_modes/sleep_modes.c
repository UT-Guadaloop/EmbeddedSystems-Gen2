...
//! MSP432E401Y devices. The user button (USR-SW1) is used to cycle through the
...
//! adjustment range varies with the MSP432E part in use. Please consult the
...
main(void)
{
    ...
    MAP_SysCtlDeepSleepClockConfigSet(1, (SYSCTL_DSLP_OSC_INT30 |
                SYSCTL_DSLP_PIOSC_PD | SYSCTL_DSLP_MOSC_DPD));
