...
GPIOA_IRQHandler(void)
{
    ...
    //
    MAP_GPIOPinWrite(GPIO_A_BASE, GPIO_A_PIN, GPIO_A_PIN);
    ...
    //
    MAP_GPIOPinWrite(GPIO_A_BASE, GPIO_A_PIN, 0);
}
...
GPIOB_IRQHandler(void)
{
    ...
    // Set GPIO high to indicate entry to this interrupt handler.
    //
    MAP_GPIOPinWrite(GPIO_B_BASE, GPIO_B_PIN, GPIO_B_PIN);
    ...
    // Set GPIO low to indicate exit from this interrupt handler.
    //
    MAP_GPIOPinWrite(GPIO_B_BASE, GPIO_B_PIN, 0);
}
...
GPIOC_IRQHandler(void)
{
    ...
    // Set GPIO high to indicate entry to this interrupt handler.
    //
    MAP_GPIOPinWrite(GPIO_C_BASE, GPIO_C_PIN, GPIO_C_PIN);
    ...
    // Set GPIO low to indicate exit from this interrupt handler.
    //
    MAP_GPIOPinWrite(GPIO_C_BASE, GPIO_C_PIN, 0);
}
...
main(void)
{
    ...
    MAP_IntPrioritySet(INT_GPIOB, 0x40);
    MAP_IntPrioritySet(INT_GPIOC, 0x00);
    ...
    MAP_IntPrioritySet(INT_GPIOA, 0x00);
    MAP_IntPrioritySet(INT_GPIOB, 0x40);
    MAP_IntPrioritySet(INT_GPIOC, 0x80);
