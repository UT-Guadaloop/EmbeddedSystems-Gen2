                 ...
                 bool bUseDMA)
{
    ...
    //
    MAP_CRCConfigSet(CCM0_BASE, (CRC_CFG_INIT_SEED | CRC_CFG_TYPE_P4C11DB7 |
                                 CRC_CFG_SIZE_32BIT));

    //
    // Write the seed.
    //
    MAP_CRCSeedSet(CCM0_BASE, ui32Seed);
    ...
    if(bUseDMA)
    {
        ...
        MAP_uDMAChannelAttributeDisable(UDMA_CH30_SW,
                                        ...
                                        UDMA_ATTR_REQMASK);
        MAP_uDMAChannelControlSet(UDMA_CH30_SW | UDMA_PRI_SELECT,
                                  UDMA_SIZE_32 | UDMA_SRC_INC_32 |
                                  UDMA_DST_INC_NONE | UDMA_ARB_1 |
                                  UDMA_DST_PROT_PRIV);
        MAP_uDMAChannelTransferSet(UDMA_CH30_SW | UDMA_PRI_SELECT,
        ...
        // Start the uDMA.
        //
        MAP_uDMAChannelRequest(UDMA_CH30_SW | UDMA_PRI_SELECT);

        //
        // Wait for the transfer to finish.
        //
        while(MAP_uDMAChannelIsEnabled(UDMA_CH30_SW))
        {
        }
        ...
        // Read the result.
        //
        ui32Result = MAP_CRCResultRead(CCM0_BASE, false);
    }
    ...
    {
        ui32Result = MAP_CRCDataProcess(CCM0_BASE, g_pui32RandomData,
                                        ui32Length, false);
    }
...
main(void)
{
    uint32_t ui32Result, ui32Errors, ui32Idx;
