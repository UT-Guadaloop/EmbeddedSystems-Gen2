...
//
//*****************************************************************************
#if defined(__GNUC__) || defined(sourcerygxx)
...
MemManage_Handler(void)
{
    ...
    //
    g_ui32MMAR = SCB->MMFAR;
    g_ui32FaultStatus = SCB->CFSR;
    SCB->CFSR = g_ui32FaultStatus;
...
main(void)
{
    ...
    // permissions.
    //
    MAP_MPURegionSet(2, SRAM_BASE + 0x8000,
    ...
    //
    MAP_MPURegionSet(6, SRAM_BASE + (MAP_SysCtlSRAMSizeGet() - (32 * 1024)),
    ...
    //
    MAP_MPUEnable(MPU_CONFIG_HARDFLT_NMI);
