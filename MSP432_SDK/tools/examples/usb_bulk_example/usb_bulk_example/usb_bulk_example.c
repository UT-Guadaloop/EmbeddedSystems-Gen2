...
// 
// This is part of revision 1.00.00.00 of the MSP432E4 Firmware Development Package.
//
//*****************************************************************************
...
// sample device provided in MSP432) and displays the returned string.
//
...
int main(int argc, char *argv[])
{
    ...
    if(!bEcho)
    {
        ...
        printf("shipped with MSP432E4 software releases for USB-enabled\n");
    ...
    hUSB = InitializeDevice(BULK_VID, BULK_PID,
                            (LPGUID)&(GUID_DEVINTERFACE_MSP432_BULK),
                            &bDriverInstalled);
    ...
    else
    {
        ...
        printf("Please make sure you have a USB-enabled MSP432E4 evaluation\n");
