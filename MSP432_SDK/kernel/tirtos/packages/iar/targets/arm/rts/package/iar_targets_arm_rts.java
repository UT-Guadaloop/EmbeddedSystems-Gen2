...
public class iar_targets_arm_rts
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/debug/iar.targets.arm.rts.arm4f',\n");
            sb.append("'lib/debug/boot.arm4f',\n");
            sb.append("'lib/debug/iar_vectortable.arm4f',\n");
            sb.append("'lib/release/iar.targets.arm.rts.arm4f',\n");
            sb.append("'lib/release/boot.arm4f',\n");
            sb.append("'lib/release/iar_vectortable.arm4f',\n");
            sb.append("'lib/debug_full/iar.targets.arm.rts.arm4f',\n");
            sb.append("'lib/debug_full/boot.arm4f',\n");
            sb.append("'lib/debug_full/iar_vectortable.arm4f',\n");
        ...
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/debug/boot.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/debug/iar_vectortable.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/release/iar.targets.arm.rts.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/release/boot.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/release/iar_vectortable.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/debug_full/iar.targets.arm.rts.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/debug_full/boot.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/debug_full/iar_vectortable.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
