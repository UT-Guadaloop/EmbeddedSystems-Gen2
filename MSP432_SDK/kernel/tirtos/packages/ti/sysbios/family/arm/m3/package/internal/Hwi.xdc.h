...
#define ti_sysbios_family_arm_m3_Hwi__INTERNAL__

#ifndef ti_sysbios_family_arm_m3_Hwi__internalaccess
...
/* enableFxn */
#undef ti_sysbios_family_arm_m3_Hwi_enableFxn
#define ti_sysbios_family_arm_m3_Hwi_enableFxn ti_sysbios_family_arm_m3_Hwi_enableFxn__E

/* restoreFxn */
#undef ti_sysbios_family_arm_m3_Hwi_restoreFxn
#define ti_sysbios_family_arm_m3_Hwi_restoreFxn ti_sysbios_family_arm_m3_Hwi_restoreFxn__E

/* plug */
#undef ti_sysbios_family_arm_m3_Hwi_plug
#define ti_sysbios_family_arm_m3_Hwi_plug ti_sysbios_family_arm_m3_Hwi_plug__E

/* getHandle */
#undef ti_sysbios_family_arm_m3_Hwi_getHandle
#define ti_sysbios_family_arm_m3_Hwi_getHandle ti_sysbios_family_arm_m3_Hwi_getHandle__E

/* setPriority */
#undef ti_sysbios_family_arm_m3_Hwi_setPriority
#define ti_sysbios_family_arm_m3_Hwi_setPriority ti_sysbios_family_arm_m3_Hwi_setPriority__E

/* excSetBuffers */
#undef ti_sysbios_family_arm_m3_Hwi_excSetBuffers
#define ti_sysbios_family_arm_m3_Hwi_excSetBuffers ti_sysbios_family_arm_m3_Hwi_excSetBuffers__E

/* initNVIC */
#undef ti_sysbios_family_arm_m3_Hwi_initNVIC
#define ti_sysbios_family_arm_m3_Hwi_initNVIC ti_sysbios_family_arm_m3_Hwi_initNVIC__E

/* initStacks */
#undef ti_sysbios_family_arm_m3_Hwi_initStacks
#define ti_sysbios_family_arm_m3_Hwi_initStacks ti_sysbios_family_arm_m3_Hwi_initStacks__E

/* flushVnvic */
#undef ti_sysbios_family_arm_m3_Hwi_flushVnvic
#define ti_sysbios_family_arm_m3_Hwi_flushVnvic ti_sysbios_family_arm_m3_Hwi_flushVnvic__E

/* reconfig */
#undef ti_sysbios_family_arm_m3_Hwi_reconfig
#define ti_sysbios_family_arm_m3_Hwi_reconfig ti_sysbios_family_arm_m3_Hwi_reconfig__E

/* postInit */
#define Hwi_postInit ti_sysbios_family_arm_m3_Hwi_postInit__I

/* updateNvic */
#define Hwi_updateNvic ti_sysbios_family_arm_m3_Hwi_updateNvic__I

/* excHandlerAsm */
#define Hwi_excHandlerAsm ti_sysbios_family_arm_m3_Hwi_excHandlerAsm__I

/* excHandler */
#define Hwi_excHandler ti_sysbios_family_arm_m3_Hwi_excHandler__I

/* excHandlerMin */
#define Hwi_excHandlerMin ti_sysbios_family_arm_m3_Hwi_excHandlerMin__I

/* excHandlerMax */
#define Hwi_excHandlerMax ti_sysbios_family_arm_m3_Hwi_excHandlerMax__I

/* excFillContext */
#define Hwi_excFillContext ti_sysbios_family_arm_m3_Hwi_excFillContext__I

/* excNmi */
#define Hwi_excNmi ti_sysbios_family_arm_m3_Hwi_excNmi__I

/* excHardFault */
#define Hwi_excHardFault ti_sysbios_family_arm_m3_Hwi_excHardFault__I

/* excMemFault */
#define Hwi_excMemFault ti_sysbios_family_arm_m3_Hwi_excMemFault__I

/* excBusFault */
#define Hwi_excBusFault ti_sysbios_family_arm_m3_Hwi_excBusFault__I

/* excUsageFault */
#define Hwi_excUsageFault ti_sysbios_family_arm_m3_Hwi_excUsageFault__I

/* excSvCall */
#define Hwi_excSvCall ti_sysbios_family_arm_m3_Hwi_excSvCall__I

/* excDebugMon */
#define Hwi_excDebugMon ti_sysbios_family_arm_m3_Hwi_excDebugMon__I

/* excReserved */
#define Hwi_excReserved ti_sysbios_family_arm_m3_Hwi_excReserved__I

/* excNoIsr */
#define Hwi_excNoIsr ti_sysbios_family_arm_m3_Hwi_excNoIsr__I

/* excDumpRegs */
#define Hwi_excDumpRegs ti_sysbios_family_arm_m3_Hwi_excDumpRegs__I
...
/* romInitNVIC */
#define Hwi_romInitNVIC ti_sysbios_family_arm_m3_Hwi_romInitNVIC__I

/* dispatchC */
#define Hwi_dispatchC ti_sysbios_family_arm_m3_Hwi_dispatchC__I

/* doSwiRestore */
#define Hwi_doSwiRestore ti_sysbios_family_arm_m3_Hwi_doSwiRestore__I

/* doTaskRestore */
#define Hwi_doTaskRestore ti_sysbios_family_arm_m3_Hwi_doTaskRestore__I

/* Module_startup */
#undef ti_sysbios_family_arm_m3_Hwi_Module_startup
#define ti_sysbios_family_arm_m3_Hwi_Module_startup ti_sysbios_family_arm_m3_Hwi_Module_startup__E

/* Instance_init */
#undef ti_sysbios_family_arm_m3_Hwi_Instance_init
#define ti_sysbios_family_arm_m3_Hwi_Instance_init ti_sysbios_family_arm_m3_Hwi_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_family_arm_m3_Hwi_Instance_finalize
#define ti_sysbios_family_arm_m3_Hwi_Instance_finalize ti_sysbios_family_arm_m3_Hwi_Instance_finalize__E

/* module */
#ifdef ti_sysbios_family_arm_m3_Hwi_Module__state__VR
...
#define module ((ti_sysbios_family_arm_m3_Hwi_Module_State *)(xdcRomStatePtr + ti_sysbios_family_arm_m3_Hwi_Module__state__V_offset))
#else
#define Hwi_module ((ti_sysbios_family_arm_m3_Hwi_Module_State *)(xdc__MODOBJADDR__(ti_sysbios_family_arm_m3_Hwi_Module__state__V)))
#if !defined(__cplusplus) ||!defined(ti_sysbios_family_arm_m3_Hwi__cplusplus)
#define module ((ti_sysbios_family_arm_m3_Hwi_Module_State *)(xdc__MODOBJADDR__(ti_sysbios_family_arm_m3_Hwi_Module__state__V)))
#endif
#endif
