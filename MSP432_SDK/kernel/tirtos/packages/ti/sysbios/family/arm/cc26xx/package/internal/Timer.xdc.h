...
/* module */
#ifdef ti_sysbios_family_arm_cc26xx_Timer_Module__state__VR
#define Timer_module ((ti_sysbios_family_arm_cc26xx_Timer_Module_State *)(xdcRomStatePtr + ti_sysbios_family_arm_cc26xx_Timer_Module__state__V_offset))
#define module ((ti_sysbios_family_arm_cc26xx_Timer_Module_State *)(xdcRomStatePtr + ti_sysbios_family_arm_cc26xx_Timer_Module__state__V_offset))
#else
