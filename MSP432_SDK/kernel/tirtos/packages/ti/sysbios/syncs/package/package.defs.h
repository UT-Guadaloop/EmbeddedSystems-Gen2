...
typedef const struct ti_sysbios_syncs_SyncSem_Fxns__* ti_sysbios_syncs_SyncSem_Module;
...
typedef const struct ti_sysbios_syncs_SyncSwi_Fxns__* ti_sysbios_syncs_SyncSwi_Module;
...
typedef const struct ti_sysbios_syncs_SyncEvent_Fxns__* ti_sysbios_syncs_SyncEvent_Module;
