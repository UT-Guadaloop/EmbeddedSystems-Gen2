...
struct ti_sysbios_heaps_HeapMem_Module_GateProxy_Fxns__ {
    ...
    xdc_IArg (*enter)(ti_sysbios_heaps_HeapMem_Module_GateProxy_Handle inst);
    xdc_Void (*leave)(ti_sysbios_heaps_HeapMem_Module_GateProxy_Handle inst, xdc_IArg key);
...
__extern ti_sysbios_heaps_HeapMem_Module_GateProxy_Handle ti_sysbios_heaps_HeapMem_Module_GateProxy_create( const ti_sysbios_heaps_HeapMem_Module_GateProxy_Params *prms, xdc_runtime_Error_Block *eb);
...
{
    if (prms != NULL) {
        ti_sysbios_heaps_HeapMem_Module_GateProxy_Params__init__S(prms, NULL, sizeof(ti_sysbios_heaps_HeapMem_Module_GateProxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
