...
/* module */
#ifdef ti_sysbios_heaps_HeapBuf_Module__state__VR
#define HeapBuf_module ((ti_sysbios_heaps_HeapBuf_Module_State *)(xdcRomStatePtr + ti_sysbios_heaps_HeapBuf_Module__state__V_offset))
#define module ((ti_sysbios_heaps_HeapBuf_Module_State *)(xdcRomStatePtr + ti_sysbios_heaps_HeapBuf_Module__state__V_offset))
#else
