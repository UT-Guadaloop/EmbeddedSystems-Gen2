...
#ifndef ti_sysbios_heaps_HeapCallback__INTERNAL__
#define ti_sysbios_heaps_HeapCallback__INTERNAL__

#ifndef ti_sysbios_heaps_HeapCallback__internalaccess
#define ti_sysbios_heaps_HeapCallback__internalaccess
#endif
...
/* alloc */
#undef ti_sysbios_heaps_HeapCallback_alloc
#define ti_sysbios_heaps_HeapCallback_alloc ti_sysbios_heaps_HeapCallback_alloc__E

/* free */
#undef ti_sysbios_heaps_HeapCallback_free
#define ti_sysbios_heaps_HeapCallback_free ti_sysbios_heaps_HeapCallback_free__E

/* isBlocking */
#undef ti_sysbios_heaps_HeapCallback_isBlocking
#define ti_sysbios_heaps_HeapCallback_isBlocking ti_sysbios_heaps_HeapCallback_isBlocking__E

/* getStats */
#undef ti_sysbios_heaps_HeapCallback_getStats
#define ti_sysbios_heaps_HeapCallback_getStats ti_sysbios_heaps_HeapCallback_getStats__E

/* getContext */
#undef ti_sysbios_heaps_HeapCallback_getContext
#define ti_sysbios_heaps_HeapCallback_getContext ti_sysbios_heaps_HeapCallback_getContext__E

/* Module_startup */
#undef ti_sysbios_heaps_HeapCallback_Module_startup
#define ti_sysbios_heaps_HeapCallback_Module_startup ti_sysbios_heaps_HeapCallback_Module_startup__E

/* Instance_init */
#undef ti_sysbios_heaps_HeapCallback_Instance_init
#define ti_sysbios_heaps_HeapCallback_Instance_init ti_sysbios_heaps_HeapCallback_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_heaps_HeapCallback_Instance_finalize
#define ti_sysbios_heaps_HeapCallback_Instance_finalize ti_sysbios_heaps_HeapCallback_Instance_finalize__E
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_ti.sysbios.heaps.HeapCallback"
typedef char ti_sysbios_heaps_HeapCallback_Object__sizingError[(sizeof(ti_sysbios_heaps_HeapCallback_Object) > sizeof(ti_sysbios_heaps_HeapCallback_Struct)) ? -1 : 1];


#endif /* ti_sysbios_heaps_HeapCallback__INTERNAL____ */
