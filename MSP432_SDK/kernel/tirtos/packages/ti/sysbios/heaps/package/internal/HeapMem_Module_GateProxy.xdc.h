...
#define ti_sysbios_heaps_HeapMem_Module_GateProxy__INTERNAL__

#ifndef ti_sysbios_heaps_HeapMem_Module_GateProxy__internalaccess
#define ti_sysbios_heaps_HeapMem_Module_GateProxy__internalaccess
#endif

#include <ti/sysbios/heaps/HeapMem_Module_GateProxy.h>
...
/* query */
#undef ti_sysbios_heaps_HeapMem_Module_GateProxy_query
#define ti_sysbios_heaps_HeapMem_Module_GateProxy_query ti_sysbios_heaps_HeapMem_Module_GateProxy_query__E

/* enter */
#undef ti_sysbios_heaps_HeapMem_Module_GateProxy_enter
#define ti_sysbios_heaps_HeapMem_Module_GateProxy_enter ti_sysbios_heaps_HeapMem_Module_GateProxy_enter__E

/* leave */
#undef ti_sysbios_heaps_HeapMem_Module_GateProxy_leave
#define ti_sysbios_heaps_HeapMem_Module_GateProxy_leave ti_sysbios_heaps_HeapMem_Module_GateProxy_leave__E

/* Module_startup */
#undef ti_sysbios_heaps_HeapMem_Module_GateProxy_Module_startup
#define ti_sysbios_heaps_HeapMem_Module_GateProxy_Module_startup ti_sysbios_heaps_HeapMem_Module_GateProxy_Module_startup__E

/* Instance_init */
#undef ti_sysbios_heaps_HeapMem_Module_GateProxy_Instance_init
#define ti_sysbios_heaps_HeapMem_Module_GateProxy_Instance_init ti_sysbios_heaps_HeapMem_Module_GateProxy_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_heaps_HeapMem_Module_GateProxy_Instance_finalize
#define ti_sysbios_heaps_HeapMem_Module_GateProxy_Instance_finalize ti_sysbios_heaps_HeapMem_Module_GateProxy_Instance_finalize__E
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_ti.sysbios.heaps.HeapMem_Module_GateProxy"
typedef char ti_sysbios_heaps_HeapMem_Module_GateProxy_Object__sizingError[(sizeof(ti_sysbios_heaps_HeapMem_Module_GateProxy_Object) > sizeof(ti_sysbios_heaps_HeapMem_Module_GateProxy_Struct)) ? -1 : 1];


#endif /* ti_sysbios_heaps_HeapMem_Module_GateProxy__INTERNAL____ */
