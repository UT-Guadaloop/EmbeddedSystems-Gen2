...
#define ti_sysbios_gates_GateTask___VERS 200
...
#ifdef ti_sysbios_gates_GateTask_Module__diagsEnabled__CR
#define ti_sysbios_gates_GateTask_Module__diagsEnabled__C (*((CT__ti_sysbios_gates_GateTask_Module__diagsEnabled*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__diagsEnabled__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__diagsEnabled (ti_sysbios_gates_GateTask_Module__diagsEnabled__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__diagsIncluded__CR
#define ti_sysbios_gates_GateTask_Module__diagsIncluded__C (*((CT__ti_sysbios_gates_GateTask_Module__diagsIncluded*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__diagsIncluded__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__diagsIncluded (ti_sysbios_gates_GateTask_Module__diagsIncluded__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__diagsMask__CR
#define ti_sysbios_gates_GateTask_Module__diagsMask__C (*((CT__ti_sysbios_gates_GateTask_Module__diagsMask*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__diagsMask__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__diagsMask (ti_sysbios_gates_GateTask_Module__diagsMask__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__gateObj__CR
#define ti_sysbios_gates_GateTask_Module__gateObj__C (*((CT__ti_sysbios_gates_GateTask_Module__gateObj*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__gateObj__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__gateObj (ti_sysbios_gates_GateTask_Module__gateObj__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__gatePrms__CR
#define ti_sysbios_gates_GateTask_Module__gatePrms__C (*((CT__ti_sysbios_gates_GateTask_Module__gatePrms*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__gatePrms__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__gatePrms (ti_sysbios_gates_GateTask_Module__gatePrms__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__id__CR
#define ti_sysbios_gates_GateTask_Module__id__C (*((CT__ti_sysbios_gates_GateTask_Module__id*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__id__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__id (ti_sysbios_gates_GateTask_Module__id__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__loggerDefined__CR
#define ti_sysbios_gates_GateTask_Module__loggerDefined__C (*((CT__ti_sysbios_gates_GateTask_Module__loggerDefined*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__loggerDefined__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__loggerDefined (ti_sysbios_gates_GateTask_Module__loggerDefined__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__loggerObj__CR
#define ti_sysbios_gates_GateTask_Module__loggerObj__C (*((CT__ti_sysbios_gates_GateTask_Module__loggerObj*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__loggerObj__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__loggerObj (ti_sysbios_gates_GateTask_Module__loggerObj__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__loggerFxn0__CR
#define ti_sysbios_gates_GateTask_Module__loggerFxn0__C (*((CT__ti_sysbios_gates_GateTask_Module__loggerFxn0*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__loggerFxn0__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__loggerFxn0 (ti_sysbios_gates_GateTask_Module__loggerFxn0__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__loggerFxn1__CR
#define ti_sysbios_gates_GateTask_Module__loggerFxn1__C (*((CT__ti_sysbios_gates_GateTask_Module__loggerFxn1*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__loggerFxn1__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__loggerFxn1 (ti_sysbios_gates_GateTask_Module__loggerFxn1__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__loggerFxn2__CR
#define ti_sysbios_gates_GateTask_Module__loggerFxn2__C (*((CT__ti_sysbios_gates_GateTask_Module__loggerFxn2*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__loggerFxn2__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__loggerFxn2 (ti_sysbios_gates_GateTask_Module__loggerFxn2__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__loggerFxn4__CR
#define ti_sysbios_gates_GateTask_Module__loggerFxn4__C (*((CT__ti_sysbios_gates_GateTask_Module__loggerFxn4*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__loggerFxn4__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__loggerFxn4 (ti_sysbios_gates_GateTask_Module__loggerFxn4__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Module__loggerFxn8__CR
#define ti_sysbios_gates_GateTask_Module__loggerFxn8__C (*((CT__ti_sysbios_gates_GateTask_Module__loggerFxn8*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__loggerFxn8__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Module__loggerFxn8 (ti_sysbios_gates_GateTask_Module__loggerFxn8__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Object__count__CR
#define ti_sysbios_gates_GateTask_Object__count__C (*((CT__ti_sysbios_gates_GateTask_Object__count*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Object__count__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Object__count (ti_sysbios_gates_GateTask_Object__count__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Object__heap__CR
#define ti_sysbios_gates_GateTask_Object__heap__C (*((CT__ti_sysbios_gates_GateTask_Object__heap*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Object__heap__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Object__heap (ti_sysbios_gates_GateTask_Object__heap__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Object__sizeof__CR
#define ti_sysbios_gates_GateTask_Object__sizeof__C (*((CT__ti_sysbios_gates_GateTask_Object__sizeof*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Object__sizeof__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Object__sizeof (ti_sysbios_gates_GateTask_Object__sizeof__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_Object__table__CR
#define ti_sysbios_gates_GateTask_Object__table__C (*((CT__ti_sysbios_gates_GateTask_Object__table*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_Object__table__C_offset)))
#else
#define ti_sysbios_gates_GateTask_Object__table (ti_sysbios_gates_GateTask_Object__table__C)
#endif
...
#ifdef ti_sysbios_gates_GateTask_A_badContext__CR
#define ti_sysbios_gates_GateTask_A_badContext (*((CT__ti_sysbios_gates_GateTask_A_badContext*)(xdcRomConstPtr + ti_sysbios_gates_GateTask_A_badContext__C_offset)))
#else
...
struct ti_sysbios_gates_GateTask_Fxns__ {
    ...
    xdc_IArg (*enter)(ti_sysbios_gates_GateTask_Handle inst);
    xdc_Void (*leave)(ti_sysbios_gates_GateTask_Handle inst, xdc_IArg key);
    xdc_runtime_Types_SysFxns2 __sfxns;
};
#ifndef ti_sysbios_gates_GateTask_Module__FXNS__CR

/* Module__FXNS__C */
__extern const ti_sysbios_gates_GateTask_Fxns__ ti_sysbios_gates_GateTask_Module__FXNS__C;
#else
#define ti_sysbios_gates_GateTask_Module__FXNS__C (*(xdcRomConstPtr + ti_sysbios_gates_GateTask_Module__FXNS__C_offset))
#endif
...
__extern xdc_Void ti_sysbios_gates_GateTask_Instance_init__E(ti_sysbios_gates_GateTask_Object *obj, const ti_sysbios_gates_GateTask_Params *prms);

/* create */
xdc__CODESECT(ti_sysbios_gates_GateTask_create, "ti_sysbios_gates_GateTask_create")
__extern ti_sysbios_gates_GateTask_Handle ti_sysbios_gates_GateTask_create( const ti_sysbios_gates_GateTask_Params *prms, xdc_runtime_Error_Block *eb);

/* construct */
xdc__CODESECT(ti_sysbios_gates_GateTask_construct, "ti_sysbios_gates_GateTask_construct")
__extern void ti_sysbios_gates_GateTask_construct(ti_sysbios_gates_GateTask_Struct *obj, const ti_sysbios_gates_GateTask_Params *prms);
...
__extern xdc_Ptr ti_sysbios_gates_GateTask_Object__create__S( xdc_CPtr aa, const xdc_UChar *pa, xdc_SizeT psz, xdc_runtime_Error_Block *eb);
...
__extern xdc_IArg ti_sysbios_gates_GateTask_enter__E( ti_sysbios_gates_GateTask_Handle instp);
...
__extern xdc_Void ti_sysbios_gates_GateTask_leave__E( ti_sysbios_gates_GateTask_Handle instp, xdc_IArg key);
...
static inline ti_sysbios_gates_GateTask_Handle ti_sysbios_gates_GateTask_Handle_downCast(xdc_runtime_IGateProvider_Handle i)
{
    ...
    return ((const void*)i2->__fxns == (const void*)&ti_sysbios_gates_GateTask_Module__FXNS__C) ? (ti_sysbios_gates_GateTask_Handle)i : (ti_sysbios_gates_GateTask_Handle)NULL;
}
...
static inline xdc_Bool ti_sysbios_gates_GateTask_Module_hasMask(void)
{
    return (xdc_Bool)(ti_sysbios_gates_GateTask_Module__diagsMask__C != (CT__ti_sysbios_gates_GateTask_Module__diagsMask)NULL);
}
...
static inline xdc_Bits16 ti_sysbios_gates_GateTask_Module_getMask(void)
{
    return (ti_sysbios_gates_GateTask_Module__diagsMask__C != (CT__ti_sysbios_gates_GateTask_Module__diagsMask)NULL) ? *ti_sysbios_gates_GateTask_Module__diagsMask__C : (xdc_Bits16)0;
}
...
static inline xdc_Void ti_sysbios_gates_GateTask_Module_setMask(xdc_Bits16 mask)
{
    if (ti_sysbios_gates_GateTask_Module__diagsMask__C != (CT__ti_sysbios_gates_GateTask_Module__diagsMask)NULL) {
        *ti_sysbios_gates_GateTask_Module__diagsMask__C = mask;
    }
}
...
{
    if (prms != NULL) {
        ti_sysbios_gates_GateTask_Params__init__S(prms, NULL, sizeof(ti_sysbios_gates_GateTask_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
...
/* Object_get */
static inline ti_sysbios_gates_GateTask_Handle ti_sysbios_gates_GateTask_Object_get(ti_sysbios_gates_GateTask_Object *oarr, int i);
static inline ti_sysbios_gates_GateTask_Handle ti_sysbios_gates_GateTask_Object_get(ti_sysbios_gates_GateTask_Object *oarr, int i) 
{
