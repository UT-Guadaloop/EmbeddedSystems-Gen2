...
#define ti_sysbios_gates_GateMutexPri__INTERNAL__

#ifndef ti_sysbios_gates_GateMutexPri__internalaccess
#define ti_sysbios_gates_GateMutexPri__internalaccess
#endif
...
/* query */
#undef ti_sysbios_gates_GateMutexPri_query
#define ti_sysbios_gates_GateMutexPri_query ti_sysbios_gates_GateMutexPri_query__E

/* enter */
#undef ti_sysbios_gates_GateMutexPri_enter
#define ti_sysbios_gates_GateMutexPri_enter ti_sysbios_gates_GateMutexPri_enter__E

/* leave */
#undef ti_sysbios_gates_GateMutexPri_leave
#define ti_sysbios_gates_GateMutexPri_leave ti_sysbios_gates_GateMutexPri_leave__E

/* insertPri */
#define GateMutexPri_insertPri ti_sysbios_gates_GateMutexPri_insertPri__I

/* Module_startup */
#undef ti_sysbios_gates_GateMutexPri_Module_startup
#define ti_sysbios_gates_GateMutexPri_Module_startup ti_sysbios_gates_GateMutexPri_Module_startup__E

/* Instance_init */
#undef ti_sysbios_gates_GateMutexPri_Instance_init
#define ti_sysbios_gates_GateMutexPri_Instance_init ti_sysbios_gates_GateMutexPri_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_gates_GateMutexPri_Instance_finalize
#define ti_sysbios_gates_GateMutexPri_Instance_finalize ti_sysbios_gates_GateMutexPri_Instance_finalize__E
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_ti.sysbios.gates.GateMutexPri"
typedef char ti_sysbios_gates_GateMutexPri_Object__sizingError[(sizeof(ti_sysbios_gates_GateMutexPri_Object) > sizeof(ti_sysbios_gates_GateMutexPri_Struct)) ? -1 : 1];


#endif /* ti_sysbios_gates_GateMutexPri__INTERNAL____ */
