...
#ifndef ti_sysbios_gates_GateHwi__INTERNAL__
#define ti_sysbios_gates_GateHwi__INTERNAL__

#ifndef ti_sysbios_gates_GateHwi__internalaccess
#define ti_sysbios_gates_GateHwi__internalaccess
#endif
...
/* query */
#undef ti_sysbios_gates_GateHwi_query
#define ti_sysbios_gates_GateHwi_query ti_sysbios_gates_GateHwi_query__E

/* enter */
#undef ti_sysbios_gates_GateHwi_enter
#define ti_sysbios_gates_GateHwi_enter ti_sysbios_gates_GateHwi_enter__E

/* leave */
#undef ti_sysbios_gates_GateHwi_leave
#define ti_sysbios_gates_GateHwi_leave ti_sysbios_gates_GateHwi_leave__E

/* Module_startup */
#undef ti_sysbios_gates_GateHwi_Module_startup
#define ti_sysbios_gates_GateHwi_Module_startup ti_sysbios_gates_GateHwi_Module_startup__E

/* Instance_init */
#undef ti_sysbios_gates_GateHwi_Instance_init
#define ti_sysbios_gates_GateHwi_Instance_init ti_sysbios_gates_GateHwi_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_gates_GateHwi_Instance_finalize
#define ti_sysbios_gates_GateHwi_Instance_finalize ti_sysbios_gates_GateHwi_Instance_finalize__E
...
#endif /* ti_sysbios_gates_GateHwi__INTERNAL____ */
