...
#ifndef ti_sysbios_gates_GateMutex__INTERNAL__
#define ti_sysbios_gates_GateMutex__INTERNAL__

#ifndef ti_sysbios_gates_GateMutex__internalaccess
#define ti_sysbios_gates_GateMutex__internalaccess
#endif
...
/* query */
#undef ti_sysbios_gates_GateMutex_query
#define ti_sysbios_gates_GateMutex_query ti_sysbios_gates_GateMutex_query__E

/* enter */
#undef ti_sysbios_gates_GateMutex_enter
#define ti_sysbios_gates_GateMutex_enter ti_sysbios_gates_GateMutex_enter__E

/* leave */
#undef ti_sysbios_gates_GateMutex_leave
#define ti_sysbios_gates_GateMutex_leave ti_sysbios_gates_GateMutex_leave__E

/* Module_startup */
#undef ti_sysbios_gates_GateMutex_Module_startup
#define ti_sysbios_gates_GateMutex_Module_startup ti_sysbios_gates_GateMutex_Module_startup__E

/* Instance_init */
#undef ti_sysbios_gates_GateMutex_Instance_init
#define ti_sysbios_gates_GateMutex_Instance_init ti_sysbios_gates_GateMutex_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_gates_GateMutex_Instance_finalize
#define ti_sysbios_gates_GateMutex_Instance_finalize ti_sysbios_gates_GateMutex_Instance_finalize__E
...
#endif /* ti_sysbios_gates_GateMutex__INTERNAL____ */
