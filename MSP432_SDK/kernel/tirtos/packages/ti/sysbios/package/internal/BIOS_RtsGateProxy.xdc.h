...
#ifndef ti_sysbios_BIOS_RtsGateProxy__INTERNAL__
#define ti_sysbios_BIOS_RtsGateProxy__INTERNAL__

#ifndef ti_sysbios_BIOS_RtsGateProxy__internalaccess
#define ti_sysbios_BIOS_RtsGateProxy__internalaccess
#endif

#include <ti/sysbios/BIOS_RtsGateProxy.h>
...
/* query */
#undef ti_sysbios_BIOS_RtsGateProxy_query
#define ti_sysbios_BIOS_RtsGateProxy_query ti_sysbios_BIOS_RtsGateProxy_query__E

/* enter */
#undef ti_sysbios_BIOS_RtsGateProxy_enter
#define ti_sysbios_BIOS_RtsGateProxy_enter ti_sysbios_BIOS_RtsGateProxy_enter__E

/* leave */
#undef ti_sysbios_BIOS_RtsGateProxy_leave
#define ti_sysbios_BIOS_RtsGateProxy_leave ti_sysbios_BIOS_RtsGateProxy_leave__E

/* Module_startup */
#undef ti_sysbios_BIOS_RtsGateProxy_Module_startup
#define ti_sysbios_BIOS_RtsGateProxy_Module_startup ti_sysbios_BIOS_RtsGateProxy_Module_startup__E

/* Instance_init */
#undef ti_sysbios_BIOS_RtsGateProxy_Instance_init
#define ti_sysbios_BIOS_RtsGateProxy_Instance_init ti_sysbios_BIOS_RtsGateProxy_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_BIOS_RtsGateProxy_Instance_finalize
#define ti_sysbios_BIOS_RtsGateProxy_Instance_finalize ti_sysbios_BIOS_RtsGateProxy_Instance_finalize__E
...
/* Object__sizingError */
#line 1 "Error_inconsistent_object_size_in_ti.sysbios.BIOS_RtsGateProxy"
typedef char ti_sysbios_BIOS_RtsGateProxy_Object__sizingError[(sizeof(ti_sysbios_BIOS_RtsGateProxy_Object) > sizeof(ti_sysbios_BIOS_RtsGateProxy_Struct)) ? -1 : 1];


#endif /* ti_sysbios_BIOS_RtsGateProxy__INTERNAL____ */
