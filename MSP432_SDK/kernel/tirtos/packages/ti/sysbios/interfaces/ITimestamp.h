...
#ifndef ti_sysbios_interfaces_ITimestamp_Module__BASE__CR

/* Interface__BASE__C */
__extern const xdc_runtime_Types_Base ti_sysbios_interfaces_ITimestamp_Interface__BASE__C;
#else
#define ti_sysbios_interfaces_ITimestamp_Interface__BASE__C (*((xdc_runtime_Types_Base *)(xdcRomConstPtr + ti_sysbios_interfaces_ITimestamp_Interface__BASE__C_offset)))
#endif
