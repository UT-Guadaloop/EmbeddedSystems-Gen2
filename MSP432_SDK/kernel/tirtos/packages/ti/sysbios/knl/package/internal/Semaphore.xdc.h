...
#ifndef ti_sysbios_knl_Semaphore__INTERNAL__
#define ti_sysbios_knl_Semaphore__INTERNAL__

#ifndef ti_sysbios_knl_Semaphore__internalaccess
...
/* registerEvent */
#undef ti_sysbios_knl_Semaphore_registerEvent
#define ti_sysbios_knl_Semaphore_registerEvent ti_sysbios_knl_Semaphore_registerEvent__E

/* reset */
#undef ti_sysbios_knl_Semaphore_reset
#define ti_sysbios_knl_Semaphore_reset ti_sysbios_knl_Semaphore_reset__E

/* pendTimeout */
#define Semaphore_pendTimeout ti_sysbios_knl_Semaphore_pendTimeout__I

/* Module_startup */
#undef ti_sysbios_knl_Semaphore_Module_startup
#define ti_sysbios_knl_Semaphore_Module_startup ti_sysbios_knl_Semaphore_Module_startup__E

/* Instance_init */
#undef ti_sysbios_knl_Semaphore_Instance_init
#define ti_sysbios_knl_Semaphore_Instance_init ti_sysbios_knl_Semaphore_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_knl_Semaphore_Instance_finalize
#define ti_sysbios_knl_Semaphore_Instance_finalize ti_sysbios_knl_Semaphore_Instance_finalize__E
...
#endif /* ti_sysbios_knl_Semaphore__INTERNAL____ */
