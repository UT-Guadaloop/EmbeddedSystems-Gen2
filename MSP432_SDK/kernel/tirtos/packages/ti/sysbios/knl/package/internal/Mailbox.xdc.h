...
#ifndef ti_sysbios_knl_Mailbox__INTERNAL__
#define ti_sysbios_knl_Mailbox__INTERNAL__

#ifndef ti_sysbios_knl_Mailbox__internalaccess
#define ti_sysbios_knl_Mailbox__internalaccess
#endif
...
/* getMsgSize */
#undef ti_sysbios_knl_Mailbox_getMsgSize
#define ti_sysbios_knl_Mailbox_getMsgSize ti_sysbios_knl_Mailbox_getMsgSize__E

/* getNumFreeMsgs */
#undef ti_sysbios_knl_Mailbox_getNumFreeMsgs
#define ti_sysbios_knl_Mailbox_getNumFreeMsgs ti_sysbios_knl_Mailbox_getNumFreeMsgs__E

/* getNumPendingMsgs */
#undef ti_sysbios_knl_Mailbox_getNumPendingMsgs
#define ti_sysbios_knl_Mailbox_getNumPendingMsgs ti_sysbios_knl_Mailbox_getNumPendingMsgs__E

/* pend */
#undef ti_sysbios_knl_Mailbox_pend
#define ti_sysbios_knl_Mailbox_pend ti_sysbios_knl_Mailbox_pend__E

/* post */
#undef ti_sysbios_knl_Mailbox_post
#define ti_sysbios_knl_Mailbox_post ti_sysbios_knl_Mailbox_post__E

/* cleanQue */
#define Mailbox_cleanQue ti_sysbios_knl_Mailbox_cleanQue__I

/* postInit */
#define Mailbox_postInit ti_sysbios_knl_Mailbox_postInit__I

/* Module_startup */
#undef ti_sysbios_knl_Mailbox_Module_startup
#define ti_sysbios_knl_Mailbox_Module_startup ti_sysbios_knl_Mailbox_Module_startup__E

/* Instance_init */
#undef ti_sysbios_knl_Mailbox_Instance_init
#define ti_sysbios_knl_Mailbox_Instance_init ti_sysbios_knl_Mailbox_Instance_init__E

/* Instance_finalize */
#undef ti_sysbios_knl_Mailbox_Instance_finalize
#define ti_sysbios_knl_Mailbox_Instance_finalize ti_sysbios_knl_Mailbox_Instance_finalize__E
...
#endif /* ti_sysbios_knl_Mailbox__INTERNAL____ */
