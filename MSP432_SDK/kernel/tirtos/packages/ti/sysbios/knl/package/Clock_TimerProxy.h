...
#define ti_sysbios_knl_Clock_TimerProxy___VERS 200
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__diagsEnabled__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__diagsEnabled*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__diagsEnabled__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__diagsEnabled (ti_sysbios_knl_Clock_TimerProxy_Module__diagsEnabled__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__diagsIncluded__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__diagsIncluded*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__diagsIncluded__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__diagsIncluded (ti_sysbios_knl_Clock_TimerProxy_Module__diagsIncluded__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__diagsMask__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__diagsMask*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__diagsMask__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__diagsMask (ti_sysbios_knl_Clock_TimerProxy_Module__diagsMask__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__gateObj__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__gateObj*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__gateObj__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__gateObj (ti_sysbios_knl_Clock_TimerProxy_Module__gateObj__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__gatePrms__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__gatePrms*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__gatePrms__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__gatePrms (ti_sysbios_knl_Clock_TimerProxy_Module__gatePrms__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__id__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__id*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__id__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__id (ti_sysbios_knl_Clock_TimerProxy_Module__id__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerDefined__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__loggerDefined*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__loggerDefined__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerDefined (ti_sysbios_knl_Clock_TimerProxy_Module__loggerDefined__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerObj__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__loggerObj*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__loggerObj__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerObj (ti_sysbios_knl_Clock_TimerProxy_Module__loggerObj__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn0__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn0*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn0__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn0 (ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn0__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn1__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn1*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn1__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn1 (ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn1__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn2__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn2*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn2__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn2 (ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn2__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn4__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn4*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn4__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn4 (ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn4__C)
#endif
...
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn8__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn8*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn8__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn8 (ti_sysbios_knl_Clock_TimerProxy_Module__loggerFxn8__C)
#endif
...
#ifdef ti_sysbios_knl_Clock_TimerProxy_Object__count__CR
#define ti_sysbios_knl_Clock_TimerProxy_Object__count__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Object__count*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Object__count__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Object__count (ti_sysbios_knl_Clock_TimerProxy_Object__count__C)
#endif
...
#ifdef ti_sysbios_knl_Clock_TimerProxy_Object__heap__CR
#define ti_sysbios_knl_Clock_TimerProxy_Object__heap__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Object__heap*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Object__heap__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Object__heap (ti_sysbios_knl_Clock_TimerProxy_Object__heap__C)
#endif
...
#ifdef ti_sysbios_knl_Clock_TimerProxy_Object__sizeof__CR
#define ti_sysbios_knl_Clock_TimerProxy_Object__sizeof__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Object__sizeof*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Object__sizeof__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Object__sizeof (ti_sysbios_knl_Clock_TimerProxy_Object__sizeof__C)
#endif
...
#ifdef ti_sysbios_knl_Clock_TimerProxy_Object__table__CR
#define ti_sysbios_knl_Clock_TimerProxy_Object__table__C (*((CT__ti_sysbios_knl_Clock_TimerProxy_Object__table*)(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Object__table__C_offset)))
#else
#define ti_sysbios_knl_Clock_TimerProxy_Object__table (ti_sysbios_knl_Clock_TimerProxy_Object__table__C)
#endif
...
struct ti_sysbios_knl_Clock_TimerProxy_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_knl_Clock_TimerProxy_Handle inst);
    xdc_Void (*setNextTick)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_UInt32 ticks);
    xdc_Void (*start)(ti_sysbios_knl_Clock_TimerProxy_Handle inst);
    xdc_Void (*stop)(ti_sysbios_knl_Clock_TimerProxy_Handle inst);
    xdc_Void (*setPeriod)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_UInt32 period);
    xdc_Bool (*setPeriodMicroSecs)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_UInt32 microsecs);
    xdc_UInt32 (*getPeriod)(ti_sysbios_knl_Clock_TimerProxy_Handle inst);
    xdc_UInt32 (*getCount)(ti_sysbios_knl_Clock_TimerProxy_Handle inst);
    xdc_Void (*getFreq)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_runtime_Types_FreqHz* freq);
    ti_sysbios_interfaces_ITimer_FuncPtr (*getFunc)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_UArg* arg);
    xdc_Void (*setFunc)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg);
    xdc_Void (*trigger)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_UInt32 cycles);
    xdc_UInt32 (*getExpiredCounts)(ti_sysbios_knl_Clock_TimerProxy_Handle inst);
    xdc_UInt32 (*getExpiredTicks)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_UInt32 tickPeriod);
    xdc_UInt32 (*getCurrentTick)(ti_sysbios_knl_Clock_TimerProxy_Handle inst, xdc_Bool save);
...
#else
#define ti_sysbios_knl_Clock_TimerProxy_Module__FXNS__C (*(xdcRomConstPtr + ti_sysbios_knl_Clock_TimerProxy_Module__FXNS__C_offset))
#endif
...
__extern ti_sysbios_knl_Clock_TimerProxy_Handle ti_sysbios_knl_Clock_TimerProxy_create( xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_knl_Clock_TimerProxy_Params *prms, xdc_runtime_Error_Block *eb);
...
__extern xdc_CPtr ti_sysbios_knl_Clock_TimerProxy_Proxy__delegate__S( void);
...
__extern xdc_UInt32 ti_sysbios_knl_Clock_TimerProxy_getMaxTicks__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp);
...
__extern xdc_Void ti_sysbios_knl_Clock_TimerProxy_setNextTick__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_UInt32 ticks);
...
__extern xdc_Void ti_sysbios_knl_Clock_TimerProxy_start__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp);
...
__extern xdc_Void ti_sysbios_knl_Clock_TimerProxy_stop__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp);
...
__extern xdc_Void ti_sysbios_knl_Clock_TimerProxy_setPeriod__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_UInt32 period);
...
__extern xdc_Bool ti_sysbios_knl_Clock_TimerProxy_setPeriodMicroSecs__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_UInt32 microsecs);
...
__extern xdc_UInt32 ti_sysbios_knl_Clock_TimerProxy_getPeriod__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp);
...
__extern xdc_UInt32 ti_sysbios_knl_Clock_TimerProxy_getCount__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp);
...
__extern xdc_Void ti_sysbios_knl_Clock_TimerProxy_getFreq__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_runtime_Types_FreqHz *freq);
...
__extern ti_sysbios_interfaces_ITimer_FuncPtr ti_sysbios_knl_Clock_TimerProxy_getFunc__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_UArg *arg);
...
__extern xdc_Void ti_sysbios_knl_Clock_TimerProxy_setFunc__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, ti_sysbios_interfaces_ITimer_FuncPtr fxn, xdc_UArg arg);
...
__extern xdc_Void ti_sysbios_knl_Clock_TimerProxy_trigger__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_UInt32 cycles);
...
__extern xdc_UInt32 ti_sysbios_knl_Clock_TimerProxy_getExpiredCounts__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp);
...
__extern xdc_UInt32 ti_sysbios_knl_Clock_TimerProxy_getExpiredTicks__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_UInt32 tickPeriod);
...
__extern xdc_UInt32 ti_sysbios_knl_Clock_TimerProxy_getCurrentTick__E( ti_sysbios_knl_Clock_TimerProxy_Handle instp, xdc_Bool save);
...
static inline ti_sysbios_knl_Clock_TimerProxy_Handle ti_sysbios_knl_Clock_TimerProxy_Handle_downCast(ti_sysbios_interfaces_ITimer_Handle i)
{
    ...
    if (ti_sysbios_knl_Clock_TimerProxy_Proxy__abstract__S() != 0U) {
        return (ti_sysbios_knl_Clock_TimerProxy_Handle)i;
    }
    return ((const void*)i2->__fxns == (const void*)ti_sysbios_knl_Clock_TimerProxy_Proxy__delegate__S()) ? (ti_sysbios_knl_Clock_TimerProxy_Handle)i : (ti_sysbios_knl_Clock_TimerProxy_Handle)NULL;
}
...
{
    if (prms != NULL) {
        ti_sysbios_knl_Clock_TimerProxy_Params__init__S(prms, NULL, sizeof(ti_sysbios_knl_Clock_TimerProxy_Params), sizeof(xdc_runtime_IInstance_Params));
    }
}
