...
/* module */
#ifdef ti_uia_loggers_LoggerStopMode_Module__state__VR
#define LoggerStopMode_module ((ti_uia_loggers_LoggerStopMode_Module_State *)(xdcRomStatePtr + ti_uia_loggers_LoggerStopMode_Module__state__V_offset))
#define module ((ti_uia_loggers_LoggerStopMode_Module_State *)(xdcRomStatePtr + ti_uia_loggers_LoggerStopMode_Module__state__V_offset))
#else
